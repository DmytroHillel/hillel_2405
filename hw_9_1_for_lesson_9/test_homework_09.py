...
class TestFunctions(unittest.TestCase):
    ...
    def test_incorrect_values(self):
        int_with_str = catch_incorrect_symbols(['1,2,3,4', '1,2,3,4,50', 'que1,2,3'])
        self.assertFalse(int_with_str)

    def test_correct_values(self):
        int_without_str = catch_incorrect_symbols(['1,2,3,4', '1,2,3,4,50', '1,2,3'])
        self.assertFalse(int_without_str)

    def test_int_val(self):
        with self.assertRaises(AttributeError):
            only_int = catch_incorrect_symbols([1, 2, 3, 4])
    ...
    def test_correct_val(self):
        ...
        self.assertFalse(int_num)

    def test_negative_numbers(self):
        negative_num = multiplication_table(-1)
        self.assertIsNone(negative_num)
